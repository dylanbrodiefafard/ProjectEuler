from typing import Set, Iterator, Iterable, Any, Tuple, Collection
...
def pythagorean_triples(c_max: int) -> Set[tuple[int, int, int]]: ...
def prime_factors(number: int) -> Iterator[tuple[int, int]]: ...
def multiplicative_partitions(number: int) -> Iterator[tuple[int]]: ...
